...
try {
  ...
  Start-Process -filepath c:/ODT/setup.exe -Wait -ArgumentList '/download', 'c:/ODT/installOfficeProPlus64.xml'
  Start-Process -filepath c:/ODT/setup.exe -Wait -ArgumentList '/configure', 'c:/ODT/installOfficeProPlus64.xml'
