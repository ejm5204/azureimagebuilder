...
try {
  ...
  Start-Process -filepath c:/ODT/setup.exe -ErrorAction Stop -ArgumentList '/download', 'c:/ODT/installOfficeProPlus64.xml'
  Start-Process -filepath c:/ODT/setup.exe -ErrorAction Stop -ArgumentList '/configure', 'c:/ODT/installOfficeProPlus64.xml'
